<h1 align="center">🎵 Nova Music Bot 🎵</h1>

<p align="center">
  <img src="https://telegra.ph/file/29808c1fd50add3b1bfc6.jpg" alt="Nova Music Logo" width="600" height="150">
</p>

<p align="center">
  <img src="https://img.shields.io/github/stars/TeamNova/Nova?style=for-the-badge&color=blue" alt="GitHub stars">
  <img src="https://img.shields.io/github/forks/TeamNova/Nova?style=for-the-badge&color=blue" alt="GitHub forks">
  <img src="https://img.shields.io/github/issues/TeamNova/Nova?style=for-the-badge&color=red" alt="GitHub issues">
  <img src="https://img.shields.io/github/license/TeamNova/Nova?style=for-the-badge&color=green" alt="GitHub license">
</p>
...
## 🚀 Deploy on Heroku 
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://dashboard.heroku.com/new?template=https://github.com/TEAMUNKNOW/Nova)
...
- Required variables mentioned in <a href="https://github.com/TEAMUNKNOW/Nova/blob/master/sample.env">sample.env</a>
...
4. **Clone the Repository**
   ```bash
   git clone https://github.com/TEAMUNKNOW/Nova && cd Nova
   ```
...
The Nova Music Bot offers a range of commands to enhance your music listening experience on Telegram:
...
For a full list of commands, use `/help` in [telegram](https://t.me/NovaBeatzBot).

---

### 🔄 Updates & Support

Stay updated with the latest features and improvements to Nova Music Bot:
...
We welcome contributions to the Nova Music Bot project. If you'd like to contribute, please follow these steps:
...
Thanks to all the contributors, supporters, and users of the Nova Music Bot. Your feedback and support keep us going!
